import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, ref, provide, createElementBlock, computed, Suspense, nextTick, mergeProps, Transition, watch, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-y60qAomX.js").then((m) => m.default || m)
  },
  {
    name: "api-contact",
    path: "/api/contact",
    ...
    component: () => import("./_nuxt/contact-DWbe9IpR.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    component: () => import("./_nuxt/contact-6_8lQwsG.js").then((m) => m.default || m)
  },
  {
    name: "ezugi",
    path: "/ezugi",
    ...
    component: () => import("./_nuxt/ezugi-DzCXYcQH.js").then((m) => m.default || m)
  },
  {
    name: "hobbies",
    path: "/hobbies",
    ...
    component: () => import("./_nuxt/hobbies-C3E_M2ha.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-CNiODx8g.js").then((m) => m.default || m)
  },
  {
    name: "lifedrops",
    path: "/lifedrops",
    ...
    component: () => import("./_nuxt/lifedrops-B-OToVpH.js").then((m) => m.default || m)
  },
  {
    name: "portfolio",
    path: "/portfolio",
    ...
    component: () => import("./_nuxt/portfolio-Co4QwRxL.js").then((m) => m.default || m)
  },
  {
    name: "readyflytalent",
    path: "/readyflytalent",
    ...
    component: () => import("./_nuxt/readyflytalent-BKU1l2KJ.js").then((m) => m.default || m)
  },
  {
    name: "resume",
    path: "/resume",
    ...
    component: () => import("./_nuxt/resume-D9FCUXF8.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-1cLAKLre.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BbxWMTNE.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BKd6DKY6.js").then((r) => r.default || r));

...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.DlbREtTT.mjs').then(interopDefault),
  "plugins/aos.js": () => import('./aos-styles.Di_uUATY.mjs').then(interopDefault),
  "components/about/About.vue": () => import('./About-styles.D6-KxlSH.mjs').then(interopDefault),
  "components/contact/Contact.vue": () => import('./About-styles.D6-KxlSH.mjs').then(interopDefault),
  "components/projects/Ezugi.vue": () => import('./About-styles.D6-KxlSH.mjs').then(interopDefault),
  "components/projects/Lifedrops.vue": () => import('./About-styles.D6-KxlSH.mjs').then(interopDefault),
